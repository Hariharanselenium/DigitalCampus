...
#Scenario: TC-01 Get Exam Marks List with Filter
 ...
 #When The order request response for Examination Marks has a '200' response code
  ...
  @NewStudentRegistraionAPIsTest @AdmissionSaleTest @pdfTest
 Scenario: TC-01 DPS 939 upload documents for student registrations
Given I send a POST request for New Student Registraion APIs with the request body from "DPS-939 upload documents for student registrations.json" and capture the response body
When The order request response for New Student Registraion APIs has a '201' response code

  @NewStudentRegistraionAPIsTest @AdmissionSaleTest @NewAPIsTest @imageTest
...
Scenario: TC-16 API to fetch student last year results by registration id.
 ...
 When The order request response for New Student Registraion APIs has a '200' response code
  ...
  @NewStudentRegistraionAPIsTest @AdmissionSaleTest @NewAPIsTest @ispdfhasTest
