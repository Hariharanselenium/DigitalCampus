...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/NewStudentRegistraionAPIs.feature",
        glue = {"com.thinktimetechno.projects.website.DigitalCampus.stepdefinitions",
...
public class NewStudentRegistraionAPIsTestRunner2 extends AbstractTestNGCucumberTests {
    @Override
